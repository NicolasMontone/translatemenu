...
import { Camera, Globe, Star, Utensils, Play } from 'lucide-react'
import type { Metadata } from 'next'

export const metadata: Metadata = {
  title: 'Translate Menu',
  description: 'Translate Menu lets diners view translated menus with AI-generated dish images.',
  icons: {
    icon: '/icon.svg',
  },
}
      ...
      <header className="max-w-[1340px] w-full mx-auto px-4">
        <div className="h-14 flex items-center justify-between">
          <Link className="flex items-center" href="/">
            <Image src="/icon.svg" alt="Translate Menu" width={24} height={24} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-500 dark:text-gray-400">
                Snap a photo, get instant translations, and personalized dish recommendations.
              </p>
            ...
            <div className="relative">
              <AspectRatio ratio={9/16} className="bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <Play className="h-16 w-16 text-gray-400" />
                  <span className="sr-only">Watch Translate Menu in Action</span>
                </div>
              </AspectRatio>
              <div className="text-center mt-4">
                <p className="text-sm text-gray-500">See Translate Menu in Action</p>
              </div>
            </div>
          </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 border border-gray-200 dark:border-gray-700 p-6 rounded-lg">
                ...
                <p className="text-center text-gray-500">
                  Take a photo of any menu and get an instant translation in your preferred language.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 border border-gray-200 dark:border-gray-700 p-6 rounded-lg">
                ...
                <p className="text-center text-gray-500">
                  Get dish recommendations based on your preferences and dietary restrictions.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 border border-gray-200 dark:border-gray-700 p-6 rounded-lg">
                ...
                <p className="text-center text-gray-500">
                  Supports over 50 languages, making it perfect for travelers and food enthusiasts.
                </p>
              </div>
            </div>
          </div>
